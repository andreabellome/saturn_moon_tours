function lissajous = wrap_lissajous_family( Ay_vect, Az_vect, m, phi, num_periods, strucNorm, lpoint )
...
% !!! Az_vect and Ay_vect should have the same length
...
for ind = 1:length(Az_vect)
    lissajous(ind) = linearised_lissajous_v2( Ay_vect(ind), Az_vect(ind), m, phi, num_periods, strucNorm, lpoint );
end
