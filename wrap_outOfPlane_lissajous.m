...
if final_prop_years < 0
    ...
    for ind = 1:length(dt_years)
        ...
        tt        = linspace( t0, t0 + dt_years(ind)*365.25*86400/strucNorm.normTime, 5e3 );
    
        lissajous = linearised_lissajous_v3( Ay, Az, m0, phi0, tt, strucNorm, lpoint );
    ...
    tt        = linspace( t0, t0 + final_prop_years(1)*365.25*86400/strucNorm.normTime, 5e3 );
