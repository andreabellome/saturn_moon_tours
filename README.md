...
5. Test script 5: [st_3_1_plot_phased_solution.m](https://github.com/andreabellome/saturn_moon_tours/blob/main/step_3_1_plot_phased_solution.m) to post-process a specific phased solution and plot it. Refer to [this section](#Section_5).
